#ifndef UNTITLED4_NRF24_H
#define UNTITLED4_NRF24_H
/*
* ----------------------------------------------------------------------------
...
extern void nrf24_setupPins() {
    ...
    // Set CE pin output (UNO - 7, MEGA - 49)
    DDRL |= (1<<DDL0);
#define NRF24_CE_PORT PORTL
#define NRF24_CE_PIN PORTL0

    // Set CS pin output (UNO - 8, MEGA - 48)
    DDRL |= (1<<DDL1);
#define NRF24_CS_PORT PORTL
#define NRF24_CS_PIN PORTL1

    // Set MISO pin input (UNO - 12, MEGA - 50)
    DDRB &= ~(1<<DDB3);
#define NRF24_MISO_PORT PINB
#define NRF24_MISO_PIN PINB3

    // Set MOSI pin output (UNO - 11, MEGA - 51)
    DDRB |= (1<<DDB2);
#define NRF24_MOSI_PORT PORTB
#define NRF24_MOSI_PIN PORTB2

    // Set SCK pin output (UNO - 13, MEGA - 52)
    DDRB |= (1<<DDB1);
#define NRF24_SCK_PORT PORTB
#define NRF24_SCK_PIN PORTB1
}
